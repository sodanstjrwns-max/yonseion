...
export const doctors: Doctor[] = [
  {
    ...
    personalNote:
      '저 역시 어린 시절(13세) 외상으로 앞니를 다쳐<br>오랜 기간 PFZ 크라운을 사용해 온 사람입니다.<br>앞니 하나가 인상과 자신감에 얼마나 큰 영향을 주는지,<br>또 보철과 함께 오래 살아간다는 것이 어떤 의미인지<br>환자의 입장에서 누구보다 잘 알고 있습니다.<br>그래서 중장년 환자분의 심미보철을, 단순한 시술이 아니라 “삶의 질을 회복하는 일”로 대합니다.',
    intro:
