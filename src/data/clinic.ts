...
export const clinic = {
  ...
  areaServed: [
    ...
    '부산광역시 동구', '경상남도 양산시', '경상남도 김해시', '울산광역시',
  ],
  // 서비스 반경 (GeoCircle) — 로컬 SEO: 병원 중심 도달 범위 명시
  serviceRadiusKm: 25,

  // --- 진료시간 ---
  hours: [
    { day: '월요일', time: '09:30 - 18:30', note: '점심 13:00-14:00' },
    { day: '화요일', time: '09:30 - 18:30', note: '점심 13:00-14:00' },
  ...
  hoursSummary: '평일 09:30-18:30 · 토 09:30-13:00 · 점심 13:00-14:00',
