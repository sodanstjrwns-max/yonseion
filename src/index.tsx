...
<style>body{font-family:Pretendard,sans-serif;background:#FAF7F1;color:#1A1611;display:grid;place-items:center;min-height:100vh;margin:0;text-align:center}
h1{font-size:5rem;margin:0;letter-spacing:-.04em}p{color:#948D81;margin:.8rem 0 2rem}
a{display:inline-block;background:#1A1611;color:#FAF7F1;padding:.85rem 1.8rem;border-radius:2px;text-decoration:none;margin:0 .3rem}</style></head>
<body><div><h1>404</h1><p>찾으시는 페이지가 없습니다.<br>주소가 바뀌었거나 삭제된 페이지일 수 있습니다.</p>
<a href="/">홈으로</a><a href="/reservation" style="background:transparent;color:#1A1611;border:1px solid #E0DACE">예약 상담</a></div></body></html>`, 404)
})
